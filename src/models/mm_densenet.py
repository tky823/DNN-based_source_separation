...
class ParallelMMDenseNet(nn.Module):
    ...
    def TimeDomainWrapper(cls, base_model, fft_size, hop_size=None, window_fn='hann'):
        return ParallelMMDenseNetTimeDomainWrapper(base_model, fft_size, hop_size=hop_size, window_fn=window_fn)
...
class ParallelMMDenseNetTimeDomainWrapper(nn.Module):
    def __init__(self, base_model: ParallelMMDenseNet, fft_size, hop_size=None, window_fn='hann'):
        super().__init__()
