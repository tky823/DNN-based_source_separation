...
def main(args):
    ...
    train_dataset = WaveTrainDataset(args.train_wav_root, args.train_list_path, mix_type='both', samples=samples, overlap=overlap, n_sources=args.n_sources)
    valid_dataset = WaveEvalDataset(args.valid_wav_root, args.valid_list_path, mix_type='both', max_samples=max_samples, n_sources=args.n_sources)
