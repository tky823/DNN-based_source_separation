...
def main(args):
    ...
    train_dataset = AugmentationWaveTrainDataset(args.musdb18_root, sr=args.sr, duration=args.duration, samples_per_epoch=args.samples_per_epoch, sources=args.sources, target=args.sources, augmentation=augmentation)
