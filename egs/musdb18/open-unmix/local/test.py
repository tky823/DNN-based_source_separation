...
def main(args):
    ...
    test_dataset = SpectrogramTestDataset(args.musdb18_root, fft_size=args.fft_size, hop_size=args.hop_size, sr=args.sr, samples=samples, sources=args.sources, target=args.sources)
