...
parser.add_argument('--enc_onesided', type=int, default=None, choices=[0, 1, None], help='Window function')
parser.add_argument('--enc_return_complex', type=int, default='hamming', choices=[0, 1, None], help='Window function')
