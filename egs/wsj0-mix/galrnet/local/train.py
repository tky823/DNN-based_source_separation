...
parser.add_argument('--kernel_size', '-M', type=int, default=2, help='Kernel size')
...
parser.add_argument('--sep_num_heads', '-J', type=int, default=4, help='Number of heads in multi-head attention')
